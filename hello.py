...
pongal = Flask(__name__)


@pongal.route('/hello', methods = ['GET'])
def hello():
    return {"message": "Hello, World!"}

@pongal.route('/menu', methods = ['GET'])
def menu():
    return {"item1": "Chakkar Pongal", "item2": "Venpongal"}

@pongal.route('/', methods=['GET'])
def index():
    return '''
<!DOCTYPE html>
<html lang="en">
...
<body>
  <div class="content">
	...
	<div class="subtitle">Let's learn how to build using CD, automated v2</div>
  </div>
</body>
</html>
'''

@pongal.route('/predict', methods=['POST'])
def predict():
